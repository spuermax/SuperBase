...
#### step 1：项目的build.gradle添加依赖
  ...
  #### step 2：app的build.gradle添加依赖
        ...
        dependencies {
            ...
          implementation 'com.github.spuermax:SuperBase:0.66'
        }   
  ...
  #### 代码混淆
        -keep class com.supe.supertest** { *; }
        -dontwarn com.supe.supertest.*
        ...
        #model防止混淆
        -keepclassmembers class * extends com.supe.supertest.common.model.QsModel {*;}
        -keepclassmembers class $ extends com.supe.supertest.common.model.QsModel {*;}

        #adapter防止混淆
        -keepclassmembers class * extends com.supe.supertest.mvp.adapter.QsListAdapterItem {*;}
        -keepclassmembers class * extends com.supe.supertest.mvp.adapter.QsRecycleAdapterItem {*;}
       ...
       -dontwarn com.bumptech.glide.load.resource.bitmap.VideoDecoder
        ...
        #Presenter防止混淆
        -keepclassmembers class * extends com.supe.supertest.mvp.presenter.QsPresenter {*;}

        #Config防止混淆
        -keepclassmembers class * extends com.supe.supertest.common.config.QsProperties{*;}      
