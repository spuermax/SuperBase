...
import com.supermax.base.common.widget.indicator.helper.ArgbEvaluatorHolder;
import com.supermax.base.common.widget.indicator.helper.FragmentContainerHelper;
...
public class LinePagerIndicator extends View implements IPagerIndicator{
    ...
    private void init(Context context) {
        ...
        mLineHeight = CommonUtils.dip2px(context, 3);
        mLineWidth = CommonUtils.dip2px(context, 10);
    }
