package com.supermax.base.common.utils.glide.transform;
...
public class FastBlurUtils {
    ...
    @NonNull
    private static Bitmap blurHeightVersion(Bitmap bitmap, int radius) {
    ...
    @NonNull
    private static Bitmap blurLowVersion(Bitmap bitmap, int radius) {
