...
import com.supermax.base.common.widget.viewpager.headerpager.base.SizeSensitiveLinearLayout;
...
public class HeaderViewPager extends FrameLayout implements OuterScroller{
    ...
    public void initView() {
        LayoutInflater.from(getContext()).inflate(R.layout.super_layout_header_viewpager, this, true);
