 ...
 * @Description 方便扩展IPagerNavigator的帮助类
...
public class NavigatorHelper {
    ...
    /**
     * ViewPager的三个回调 onPageSelect  onScrolled onPageScrolledStateChanged
     */
    public interface OnNavigatorScrollListener {
        void onEnter(int index, int totalCount, float enterPercent, boolean leftOrRight);
